...
{
    $result = array();
    $result[] = array('caption' => 'Kategori', 'short_caption' => 'Kategori', 'filename' => 'kategori.php', 'name' => 'kategori', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Produk', 'short_caption' => 'Produk', 'filename' => 'produk.php', 'name' => 'produk', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
...
{
    return
        '<div class="alert alert-danger SQLGeneratorEvaluationVersion"><h3 class="SQLGeneratorEvaluationVersion-head">Cozastore</h3><img class="SQLGeneratorEvaluationVersion-justify" src="components/assets/img/btn-loading.png"></div>';
}

function GetPagesFooter()
{
    return
        '<p align="right">Latihan</p>';
}
